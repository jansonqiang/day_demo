...
public class OkHttpClientManager
{
     ...
     * @param context
     */
    private void setHttpsDelegate(Context context){

        HttpsDelegate httpsDelegate = new HttpsDelegate(context);
        httpsDelegate.makeHttps(mOkHttpClient);
    }

    public class HttpsDelegate{

        private String TAG = HttpsDelegate.class.getName();


        private Context context;

        public HttpsDelegate(Context context) {
       ...
       // private static final String ENDPOINT = "https://efuservice.taskmed.com.cn/doctor/users/stat";
        ...
        private static final int bksId = R.raw.efuservice;
        ...
        public  SSLSocketFactory getPinnedCertSslSocketFactory() {
            try {
                ...
                InputStream in = context.getResources().openRawResource(bksId);
